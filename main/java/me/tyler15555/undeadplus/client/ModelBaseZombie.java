...
public class ModelBaseZombie extends ModelBiped {
    ...
    public ModelBaseZombie()
    {
        this(0.0F);
    }

    public ModelBaseZombie(float par1)
    {
        this(par1, 0.0F, 64, 32);
    }

    public ModelBaseZombie(float par1, float par2, int par3, int par4)
    {
        this.heldItemLeft = 0;
